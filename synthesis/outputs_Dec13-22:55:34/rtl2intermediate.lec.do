...
usage -auto -elapse
set log file logs_Dec13-22:55:34/rtl2intermediate.lec.log -replace
tclmode
...
vpx read design -verilog -revised -lastmod -noelab \
	outputs_Dec13-22:55:34/riscv_steel_core_intermediate.v
} else {
...
write hier_compare dofile outputs_Dec13-22:55:34/hier_rtl2intermediate.lec.do \
...
run hier_compare outputs_Dec13-22:55:34/hier_rtl2intermediate.lec.do -dynamic_hierarchy
