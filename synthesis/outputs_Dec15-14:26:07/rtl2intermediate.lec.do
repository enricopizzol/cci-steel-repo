...
usage -auto -elapse
set log file logs_Dec15-14:26:07/rtl2intermediate.lec.log -replace
tclmode
...
vpx read design -verilog -revised -lastmod -noelab \
	outputs_Dec15-14:26:07/riscv_steel_core_intermediate.v
} else {
...
write hier_compare dofile outputs_Dec15-14:26:07/hier_rtl2intermediate.lec.do \
...
run hier_compare outputs_Dec15-14:26:07/hier_rtl2intermediate.lec.do -dynamic_hierarchy
