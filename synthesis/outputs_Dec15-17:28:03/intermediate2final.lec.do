...
usage -auto -elapse
set log file logs_Dec15-17:28:03/intermediate2final.lec.log -replace
tclmode
...
elaborate design -golden -root riscv_steel_core

tclmode
if {$ver < 13.10} {
vpx read design -verilog -revised -lastmod -noelab \
	outputs_Dec15-17:28:03/riscv_steel_core_m.v
} else {
