...
usage -auto -elapse
set log file logs_Dec15-17:21:02/rtl2intermediate.lec.log -replace
tclmode
...
vpx read design -verilog -revised -lastmod -noelab \
	outputs_Dec15-17:21:02/riscv_steel_core_intermediate.v
} else {
...
write hier_compare dofile outputs_Dec15-17:21:02/hier_rtl2intermediate.lec.do \
...
run hier_compare outputs_Dec15-17:21:02/hier_rtl2intermediate.lec.do -dynamic_hierarchy
